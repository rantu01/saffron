...
import { getVipTasksPerSet } from "./vipModel";
...
export async function initializeUserTaskSet(uid, setNumber = 1, options = {}) {
  ...
  const taskSet = {
    ...
    currentPosition: 0,
    completedTasks: 0,
    totalTasks: options.totalTasks || getVipTasksPerSet(options.vipLevel || null),
    createdAt: new Date(),
    updatedAt: new Date(),
  };
