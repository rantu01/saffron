...
// Returns the number of tasks per set for a given VIP level, defaulting to the
// base tier (VIP 1 = 20). This is the single source of truth for the per-set
// task count and replaces the previously hardcoded value of 30.
export function getVipTasksPerSet(level) {
  const tier = getVipTier(level);
