      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12 border-b border-gray-200/60">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5 text-sm text-gray-600 font-medium">
              {[{ name: "Home", href: "/home" }, { name: "About Us", href: "/about-us" }, { name: "Case Studies", href: "/case-study" }, { name: "Careers", href: "#" }, { name: "Testimonials", href: "/testimonials" }].map((link, i) => (
                <li key={i}><Link href={link.href} className="hover:text-[#E05305] transition-colors">{link.name}</Link></li>
              ))}
            </ul>
          </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6 relative">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 text-sm text-gray-500 font-medium w-full md:w-auto justify-between md:justify-end">
            ...
            <div className="flex items-center gap-4 md:gap-6 z-10">
              ...
              <Link href="/terms-conditions" className="hover:text-[#E05305] transition-colors">Terms & Conditions</Link>
              <span className="text-gray-200">|</span>
              <Link href="/privacy-policy" className="hover:text-[#E05305] transition-colors">Privacy Policy</Link>
            </div>
          </div>
